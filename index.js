...
import mk_app_maintenance_card from './apps/mk-app-maintenance-card/index.js'
...
import mk_app_user_list_new from './apps/mk-app-user-list-new/index.js'
import mk_app_jobplan_list from './apps/mk-app-jobplan-list/index.js'

import mk_app_asset_overview from './apps/mk-app-asset-overview/index.js'
import mk_app_asset_infoTab from './apps/mk-app-asset-infoTab/index.js'
import mk_app_preventive_maintainance_list from './apps/mk-app-preventive-maintainance-list/index.js'
...
import mk_app_asset_hierarchy_detail from './apps/mk-app-asset-hierarchy/apps/mk-app-asset-hierarchy-detail/index.js'
import mk_app_asset_hierarchy_type from './apps/mk-app-asset-hierarchy/apps/mk-app-asset-hierarchy-type/index.js'
import mk_app_asset_hierarchy from './apps/mk-app-asset-hierarchy/index.js'
...
//line dash
import mk_app_line_dash from './apps/mk-app-line-dash'
...
const apps = {
	...
	[mk_app_maintenance_card.name]: mk_app_maintenance_card,
	[mk_app_person_list.name]: mk_app_person_list,	
	[mk_app_user_list.name]: mk_app_user_list,
	[mk_app_user_list_new.name]: mk_app_user_list_new,
	[mk_app_jobplan_list.name]: mk_app_jobplan_list,
	[mk_app_asset_overview.name]: mk_app_asset_overview,
	[mk_app_asset_infoTab.name]: mk_app_asset_infoTab,
	[mk_app_preventive_maintainance_list.name]: mk_app_preventive_maintainance_list,	
	...
	[mk_app_asset_hierarchy_detail.name]: mk_app_asset_hierarchy_detail,	
	[mk_app_asset_hierarchy_type.name]: mk_app_asset_hierarchy_type,
	[mk_app_asset_hierarchy.name]: mk_app_asset_hierarchy,
	...
	[mk_app_line_dash.name]: mk_app_line_dash
}
